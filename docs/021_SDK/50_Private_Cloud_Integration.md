...
<div data-duration-in="300" data-duration-out="100" class="docs-tabs w-tabs">
	...
	<div class="docs-tabs-content w-tab-content">
		<div data-w-tab="tab-android" class="w-tab-pane w--tab-active">
			<h3>Syntax</h3>
      <p>
        <code>TestFairy.setServerEndpoint("&lt;your private cloud url here&gt;");</code><br />
      </p>
      <h3>Code Example</h3>
      <pre>
...
TestFairy.begin("&lt;your app token here&gt;");
		...
		<div data-w-tab="tab-nativescript" class="w-tab-pane">
			<h3>Syntax</h3>
      <p>
        <code>TestFairySDK.setServerEndpoint("&lt;your private cloud url here&gt;");</code><br />
      </p>
      <h3>Code Example</h3>
      <pre>
// Be sure to import TestFairy
...
TestFairy.begin("&lt;your app token here&gt;");
		...
		<div data-w-tab="tab-adobe-air" class="w-tab-pane">
			<h3>Syntax</h3>
      <p>
        <code>AirTestFairy.setServerEndpoint("&lt;your private cloud url here&gt;");</code><br />
      </p>
      <h3>Code Example</h3>
      <pre>
// Be sure to import TestFairy
...
AirTestFairy.begin("&lt;your app token here&gt;");
		...
		<div data-w-tab="tab-titanium" class="w-tab-pane">
			<h3>Syntax</h3>
      <p>
        <code>TiTestFairy.setServerEndpoint("&lt;your private cloud url here&gt;");</code><br />
      </p>
      <h3>Code Example</h3>
      <pre>
// Be sure to import TestFairy
