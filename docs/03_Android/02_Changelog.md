...
* [NEW] TestFairy Android SDK and NDK support extension distributions are moved to a new group id named `com.testfairy`. Please follow [these steps](TODO) to adapt your project.
